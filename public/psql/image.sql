...
UPDATE hpbdata SET image = '/images/Kway teow goreng' WHERE id = '1438';
UPDATE hpbdata SET image = '/images/Claypot rice with mixed vegetable' WHERE id = '758';
UPDATE hpbdata SET image = '/images/Char kway teow' WHERE id = '516';
UPDATE hpbdata SET image = '/images/Chicken porridge' WHERE id = '615';
